...
define_crosscall_resolver!(cc_send_message, "kernel_0.0.0/SendMessage", extern "C" fn (*const u8, usize) -> i32);
define_crosscall_resolver!(cc_recv_message, "kernel_0.0.0/RecvMessage", extern "C" fn (*mut u8, usize) -> i32);
define_crosscall_resolver!(cc_map_heap, "user_0.0.0/MapHeap", extern "C" fn (usize) -> usize);
